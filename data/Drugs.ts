...
export const drugs: {
...
}[] = [
  {
    ...
    analyse: new TextBuilder()
      ...
      .addLine(
        "- **Chemische Analyse:** Ein Farbreaktionstest ergab keine Reaktion."
      )
      .addLine(
      ...
      .addLine(
        "- Die analysierten Cannabissamen enthalten keine psychoaktiven Substanzen wie THC."
      )
      .addLine(
  ...
  },
  {
    ...
    analyse: new TextBuilder()
      ...
      .addLine(
        "- **Überzugsmittel:** Um die Tablette leichter schluckbar zu machen."
      )
      .addLine("")
      .addLine(
        "**Chemische Eigenschaften und Pharmakokinetik von Pseudoephedrin:**"
      )
      .addLine("")
      .addLine("**Struktur:**")
      .addLine("")
