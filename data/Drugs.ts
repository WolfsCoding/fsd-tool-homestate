...
export const drugs: {
    ...
    {
        name: "Cannabis Samen",
        analyse: new TextBuilder().addLine("`Cannabis Samen:` <br>").addLine("- **Mikroskopische Analyse:** Die Samen zeigen die typische ovale Form und dunkle Musterung, die für Cannabissamen charakteristisch sind..").addLine("- **Chemische Analyse:** Ein Farbreaktionstest ergab keine Reaktion.").addLine("- **Quantitative Analyse:** Es wurde keine signifikante Menge an Tetrahydrocannabinol (THC) oder anderen Cannabinoiden in den Samen nachgewiesen.").addLine("").addLine("`Schlussfolgerung:`").addLine("- Die analysierten Cannabissamen enthalten keine psychoaktiven Substanzen wie THC.").addLine("- Die ausgewachsene Pflanze aus den Samen kann bei geeigneten Anbaubedingungen über einen relevanten THC-Gehalt verfügen."),
        variables: [],
    },
    {
