...
async function addDrug(toxiId: string, drug: { name: string; amount: number; tested: number; unit: string; variables: { key: string; value: string }[] }) {
