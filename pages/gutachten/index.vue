    ...
    <div class="flex flex-col sm:gap-4 sm:py-4">
      ...
      <main class="grid flex-1 items-start gap-4 p-4 sm:px-6 sm:py-0 md:gap-8">
        <Table>
          ...
          <TableBody>
            <TableRow
              v-for="gutachtenItem in gutachten.filter(
                (x) =>
            ...
            >
              ...
              <TableCell>
                {{ getFormattedDate(gutachtenItem.createdAt, 'DD.MM.YYYY hh:mm Uhr') }}</TableCell
              >
              ...
              <TableCell class="[--table-padding:0] pl-4">
                <DropdownMenu>
                  ...
                  <DropdownMenuContent>
                    ...
                    >
                    <DropdownMenuItem @click="handleRemoveGutachten(gutachtenItem.id)"
