...
export default defineNuxtPlugin(() => {
    ...
    // @ts-ignore
    window.FontAwesomeKitConfig = { id: 8912579, version: "6.5.2", token: "d61cb71152", method: "css", baseUrl: "https://ka-f.fontawesome.com", license: "pro", asyncLoading: { enabled: false }, autoA11y: { enabled: true }, baseUrlKit: "https://kit.fontawesome.com", detectConflictsUntil: null, iconUploads: {}, minify: { enabled: true }, v4FontFaceShim: { enabled: true }, v4shim: { enabled: true }, v5FontFaceShim: { enabled: true } };
    !(function (t) {
